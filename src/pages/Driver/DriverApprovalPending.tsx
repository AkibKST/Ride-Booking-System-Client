...
export default function DriverApprovalPending() {
  ...
  const { data: driverProfile } = useGetMyDriverProfileQuery(undefined, {
    pollingInterval: 5000, // Poll every 5 seconds
    refetchOnMountOrArgChange: true, //refetch
  });

  useEffect(() => {
    // Check if driver is approved
    console.log("Checking driver approval status...", driverProfile);
            ...
            <div className="flex items-start gap-3 rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-950 animate-pulse">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-green-700 dark:text-green-300">
                  Your driver profile has been approved. Taking you to view
                  available rides...
                </p>
              </div>
            </div>
