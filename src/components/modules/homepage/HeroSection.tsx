          ...
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground mx-auto max-w-3xl lg:text-xl">
                Here at Encrypted Service, we prioritize your privacy and data
                security above all else. Our platform is designed to provide
                top-notch ride sharing services while ensuring that your
